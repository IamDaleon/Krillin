  ...
  <div class="flex__container flex--pikachu flex--active" data-slide="1">
    <div class="flex__item flex__item--left">
      <div class="flex__content">
        <p class="text--sub">O.P.M.S</p>
        <h1 class="text--big">GOLD</h1>
    ...
    <button class="product-btn">READ MORE</button>  
      ...
      <p class="text__background">GOLD</p>
    </div>
    <div class="flex__item flex__item--right"></div>
    <img class="pokemon__img" src="<?php echo get_template_directory_uri(); ?>/assets/images/Gold-Liquid.webp" />
  </div>
